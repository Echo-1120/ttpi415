...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train DQN with MLP / TT / hybrid Q-network")
    parser.add_argument("--env-id", default="CartPole-v1")
    parser.add_argument("--seed", type=int, default=7)
    parser.add_argument("--critic-arch", choices=("mlp", "tt", "hybrid"), default="mlp", dest="q_arch")
